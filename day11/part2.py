...
def step(grid):
    ...
    # It feels like there must be a smarter method of computing this, but this
    # was so quick I just simulated it out "infinite" steps.
    if len(already_flashed) == len(newgrid) * len(newgrid[0]):
        all_flashed = True

    for i,j in already_flashed:
        newgrid[i][j] = 0

    return total_flashes, newgrid, all_flashed
...
if __name__ == '__main__':
    ...
    for i in range(10000):
        flashes, grid, all_flashed = step(grid)
